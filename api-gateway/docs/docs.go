...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.SwaggerRespGetMessage"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SwaggerReqSendMessage"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.SwaggerRespGetMessage": {
            "type": "object",
            "properties": {
                "Data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.RespGetMessage"
                    }
                },
                "Message": {
                    "type": "string"
